...
public:
    ...
    void addCourse(string CRN, int count)
    {
        ...
        sqlite3* DB;
        int exit = 0;
        exit = sqlite3_open("C:\\Users\\ennise\\OneDrive - Wentworth Institute of Technology\\Desktop\\Applied Programming\\SQLite\\assignment3.db", &DB);            //open the database
        char* messageError = 0;
        ...
        if (count == 0) {
            ...
            if (container.size() == 0) {
                cout << "Incorrect CRN. Try again." << endl;
            }
            else {
            ...
            if (container.size() == 0) {
                ...
                string day = ("SELECT * FROM SCHEDULE WHERE SEMESTER = ('" + container[6] + "');");
                exit = sqlite3_exec(DB, day.c_str(), courseCheck, &days, &messageError);

                if (container[5] == days[5]) {
                    if (container[4] == days[4]) {
                        cout << "Time/day conflict in schedule. Try again.\n";
                    }
                }
                else {
                    string insertCourse = ("INSERT INTO SCHEDULE VALUES('" + container[0] + "', '" + container[1] + "', '" + container[2] + "', '" + container[3] + "', '" + container[4] + "', '" + container[5] + "', '" + container[6] + "', '" + container[7] + "', '" + container[8] + "');");
...
public:
    ...
    void addCourse()
    {
        ...
        exit = sqlite3_exec(DB, insert.c_str(), callback, NULL, &messageError);
    }//end function
    void removeCourse()
    {
        sqlite3* DB;
        ...
        exit = sqlite3_exec(DB, remove.c_str(), callback, NULL, &messageError);
    ...
    void addInstructor()
    {
        ...
        string ID, first, last, title, year, dept, email, password;
        ...
        cin >> password;
        string insert("INSERT into INSTRUCTOR VALUES('" + ID + "', '" + first + "', '" + last + "', '" + title + "', '" + year + "', '" + dept + "', '" + email + "', '" + password + "'); ");
        exit = sqlite3_exec(DB, insert.c_str(), callback, NULL, &messageError);
    }//end function
    ...
    void addStudent()
    {
        ...
        string ID, first, last, year, dept, email, password;
        ...
        cout << "Enter in the last name: ";
        cin >> last;
        cout << "Enter in the graduation year: ";
        cin >> year;
        cout << "Enter in the department: ";
        cin >> dept;
        cout << "Enter in the email: ";
        ...
        cout << "Enter in the password: ";
        cin >> password;
        string insert("INSERT into STUDENT VALUES('" + ID + "', '" + first + "', '" + last + "', '" + year + "', '" + dept + "', '" + email + "', '" + password + "');");
        exit = sqlite3_exec(DB, insert.c_str(), callback, NULL, &messageError);
    }//end function
    void removeStudent()
    {
    ...
    void linkUnlink() {
        ...
        if (option == 1) {
            int linkChoice;
            cout << "Do you want to link student (1) or instructor (2): ";
            cin >> linkChoice;
            if (linkChoice == 1) {
                string email;
                ...
                cin >> last;
                string link = ("UPDATE COURSES SET STUDENT = ('" + last + "') WHERE CRN = ('" + crn + "');");
                exit = sqlite3_exec(DB, link.c_str(), callback, NULL, &messageError);
            }
            else {
                cout << "Invalid input\n";
        ...
        //unlink
            ...
            int unChoice;
            cout << "Do you want to unlink student (1) or instructor (2): ";
            cin >> unChoice;
            if (unChoice == 1) {
...
int main(int argc, char** argv)
{
    ...
    ********************************************************************/
    ...
    //clear the schedule table before login to allow new user to build schedule
...
#pragma region Student menu
    ...
    if (choice1 == 1)
    {
        ...
        } while (exitLoop != 1); //end student login
...
//choice1 will hold 2 for instructor
    else if (choice1 == 2)
    {
        ...
        if (choice1 == 2)
        {
            ...
            } while (choice2 != 9); //choice2 = 9 will quit
        }//end instructor menu
...
//choice 1 holds option for user type
    else if (choice1 == 3)
    {
        ...
        if (choice1 == 3)
        {
            //clear all linked students every iteration
            string clear = ("UPDATE COURSES SET STUDENT = '';");
            exit = sqlite3_exec(DB, clear.c_str(), adminLogin, NULL, &messageError);
            do
            {
                //enter integer for option
                cout << "Enter in the number of your choice: \n";
                cout << "1. Add course\n2. Remove course\n3. Search all courses\n4. Search one course\n5. Add Student\n6. Add Instructor\n7. Remove Student\n8. Remove Instructor\n9. Print Students\n10. Print Instructors\n11. Link/Unlink Student/Instructor\n12. Quit\n";
                cin >> choice2; //choice2 holds student menu option
                //switch for different options
                switch (choice2)
                {
            ...
            } while (choice2 != 12); //choice2 = 12 will quit
        }//end admin menu
    }//end login for admin
#pragma endregion
